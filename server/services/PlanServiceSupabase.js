...
PlanServiceSupabase.DEFAULT_FEATURES = DEFAULT_FEATURES;
PlanServiceSupabase.DEFAULT_QUOTAS = DEFAULT_QUOTAS;
PlanServiceSupabase.VALID_USER_FEATURES = VALID_USER_FEATURES;
PlanServiceSupabase.validatePlanFeatures = validatePlanFeatures;
PlanServiceSupabase.filterValidFeatures = filterValidFeatures;

module.exports = PlanServiceSupabase;
