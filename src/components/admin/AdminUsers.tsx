...
const AdminUsers = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      usersWithAvatarState.forEach(async (user) => {
    ...
    <div className="space-y-6 w-full max-w-none mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {selectedUsers.size > 0 && (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                <DropdownMenuItem onClick={() => handleBulkAction(['bot'])}>
                  <Bot className="h-4 w-4 mr-2" />
                  Aplicar Bot Padrão
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => handleBulkAction(['labels'])}>
                  <Tags className="h-4 w-4 mr-2" />
                  Aplicar Labels Padrão
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => handleBulkAction(['canned_responses'])}>
                  <MessageSquareText className="h-4 w-4 mr-2" />
                  Aplicar Respostas Rápidas
                </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={() => handleBulkAction(['bot', 'labels', 'canned_responses'])}>
                  <Zap className="h-4 w-4 mr-2" />
          ...
          <Button onClick={fetchUsers} variant="outline" size="icon" className="flex-shrink-0">
                        ...
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-48">
                              ...
                              <DropdownMenuItem onClick={() => handleCopyToken(user.token)}>
