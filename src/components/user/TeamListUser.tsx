/**
 * TeamListUser Component
 * 
 * Displays list of teams with member count for user dashboard.
 * Reuses logic from admin TeamList.
 * 
 * Requirements: 3.1
 */
    ...
    <div className="space-y-6 w-full max-w-none mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {onCreateTeam && (
            <Button onClick={handleCreateTeam} disabled={maxTeamsReached}>
